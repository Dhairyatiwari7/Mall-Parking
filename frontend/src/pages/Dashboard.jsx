...
const Dashboard = () => {
  ...
  const fetchRevenueData = async () => {
    try {
      ...
      // Don't show error toast for revenue as it's not critical for dashboard loading
    }
  };
  ...
  useEffect(() => {
    // Fetch both dashboard and revenue data
    fetchDashboardData();
    fetchRevenueData();
  }, []);
          ...
          <div className="border-b border-gray-200 bg-gray-50">
            <nav className="flex space-x-8 px-8">
              {[
                ...
                { id: 'vehicles', label: 'Vehicle Details', icon: '🚗' },
